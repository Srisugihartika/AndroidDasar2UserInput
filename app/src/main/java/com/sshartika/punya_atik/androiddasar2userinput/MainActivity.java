package com.sshartika.punya_atik.androiddasar2userinput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (spinnerPilihan.getSelectedItem().toString().equals(pilihHitung[0])) {
                    //rumus volum
                    rumusVolume();
                    //ctrl+alt+m
                }else if (spinnerPilihan.getSelectedItem().toString().equals(pilihHitung[1])) {
                    //rumus keliling
                    Double sisi = Double.valueOf(edSisi.getText().toString());
                    rumusKeliling(sisi);
                }else if (spinnerPilihan.getSelectedItem().toString().equals(pilihHitung[2])) {
